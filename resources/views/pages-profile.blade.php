...
@section(  'GHO | Dashboard') GHO - Profile @endsection
          ...
          <div class="col-lg-4 col-xlg-3 col-md-5 ar-dir">
            <div class="card border-radios">
              <div class="card-body profile-card">
                <center class="mt-4">
                  <img src="./assets/images/users/default.png" class="rounded-circle" width="150" />
                  <h4 class="card-title mt-2">اسم المستخدم</h4>
                  <h6 class="card-subtitle">الوظيفة / المسمى الوظيفي</h6>
                </center>
              </div>
            </div>
          </div>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="mb-3">
                      ...
                      <p class="form-control-plaintext">اسم المستخدم</p>
                    </div>
                    <div class="mb-3">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="mb-3">
                      ...
                      <p class="form-control-plaintext">اسم الموظف الكامل</p>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">القسم:</label>
                      <p class="form-control-plaintext">قسم المبيعات</p>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <p class="form-control-plaintext">1444 / 2023</p>
                    </div>
                  </div>
                </div>
              </div>
